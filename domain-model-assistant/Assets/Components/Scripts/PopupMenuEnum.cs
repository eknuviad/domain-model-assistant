...
public class PopupMenuEnum : MonoBehaviour
{
    ...
    public void SetCompartmentedRectangle(CompartmentedRectangle compRect)
    {
        ...
        this.transform.GetChild(0).GetComponent<UnityEngine.UI.Button>().onClick.AddListener(compRect.GetSection(0).GetComponent<Section>().AddLiteral);
        ...
        this.transform.GetChild(1).GetComponent<UnityEngine.UI.Button>().onClick.AddListener(compRect.Destroy);
    }
